...
Step 1: Read from input the carpet price per square foot (float), room width (int) and room length (int). Calculate the room area in square feet. Calculate the carpet price based on square feet with an additional 20% for waste. Output square feet and carpet cost.
'''
...
# Order #1
# Input price per square foot, room width and room length
...
# Calculate labor costs (0.75 per square foot)
...
# Output results
print("Order #1")
print(f"Square Footage: {sq_feet:.2f} square feet.")
